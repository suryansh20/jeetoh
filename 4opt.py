...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="chrome trivia", description="**Answer Choice**",color=0x98FB98)
...
#thats is command lo
        if message.content.lower() == "-go1":
            ...
            if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
                ...
                await message.channel.send("**chal** beta tere bas ki bat nahi ha  **** :stuck_out_tongue_winking_eye:")
            return
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjU0MzA2NTM2NTMyODY5MTIw.XiRvgQ.lsuAHZK5gAgrZG9XTfVlTcCnF2I'))
    loop.run_forever()
